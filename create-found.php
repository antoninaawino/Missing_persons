                            ...
                            <div class="col-md-12 login-form">
                                ...
                                <form action="functions/controller.php" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="phone">Date found</label>
                                        ...
                                        <input type="submit" value="submit" name="create_found">
                                    </div>
                                </form>
                ...
                <div class="col-md-3">
                    <aside>
                        <ul>
                            ...
                            <li class="active"><a href="create-found.php">Add found persons</a></li>
